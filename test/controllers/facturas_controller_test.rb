...
class FacturasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create factura" do
    assert_difference('Factura.count') do
      post facturas_url, params: { factura: { folio: @factura.folio, user_id: @factura.user_id } }
    end
  ...
  test "should update factura" do
    patch factura_url(@factura), params: { factura: { folio: @factura.folio, user_id: @factura.user_id } }
