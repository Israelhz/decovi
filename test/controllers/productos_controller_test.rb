...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post productos_url, params: { producto: { acabado: @producto.acabado, cantidad: @producto.cantidad, nombre: @producto.nombre } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { acabado: @producto.acabado, cantidad: @producto.cantidad, nombre: @producto.nombre } }
