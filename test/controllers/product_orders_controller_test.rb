...
class ProductOrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_order" do
    assert_difference('ProductOrder.count') do
      post product_orders_url, params: { product_order: { cantidad: @product_order.cantidad, pedido_id: @product_order.pedido_id, producto_id: @product_order.producto_id } }
    end
  ...
  test "should update product_order" do
    patch product_order_url(@product_order), params: { product_order: { cantidad: @product_order.cantidad, pedido_id: @product_order.pedido_id, producto_id: @product_order.producto_id } }
